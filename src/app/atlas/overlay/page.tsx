      ...
      <section className="w-full max-w-sm rounded-3xl border border-cyan-300/30 bg-slate-950/88 p-4 shadow-2xl shadow-cyan-950/30 backdrop-blur-xl">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-lg font-semibold text-white">Daily Mission Ring</h1>
          </div>
          <div className="flex h-16 w-16 items-center justify-center rounded-full border border-cyan-300/30 bg-slate-900 text-xl font-semibold text-cyan-100" style={{ background: `conic-gradient(#22d3ee ${atlas.missionCompletionPct}%, rgba(15,23,42,0.9) 0)` }} aria-label="Mission progress ring">
        ...
        <p className="mt-3 text-xs leading-5 text-slate-400">Time alone does not fill this ring. Only validated Lambenti progress changes mission progress. {brief.privacyMarker}</p>
      </section>
    </main>
  );
}
